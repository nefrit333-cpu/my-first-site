...
[Открыть релиз v1.7](https://github.com/nefrit333-cpu/my-first-site/releases/tag/v1.7)
...
Проект уже прошёл два полноценных рабочих цикла через GitHub:
...
- `projects.css` — дополнительные стили для блока проектов и мобильной версии
