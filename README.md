...
[Открыть релиз v2.4](https://github.com/nefrit333-cpu/my-first-site/releases/tag/v2.4)
...
- Git и GitHub — версии, ветки, Pull Request и публикация
