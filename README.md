...
[Открыть релиз v2.0](https://github.com/nefrit333-cpu/my-first-site/releases/tag/v2.0)
...
Раздел контактов содержит учебную форму заявки.
...
Проект уже прошёл пять полноценных рабочих циклов через GitHub:
