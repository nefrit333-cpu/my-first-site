...
[Открыть релиз v2.8](https://github.com/nefrit333-cpu/my-first-site/releases/tag/v2.8)
...
- усиленный блок “Проекты”
- проекты оформлены как frontend-кейсы
- первый проект представлен как опубликованный frontend-кейс
- лендинг услуги представлен как опубликованный учебный frontend-кейс
- лучше показаны задача, результат и стек проекта
- отдельная страница `landing.html`
- отдельный файл стилей `landing.css`
- учебный лендинг услуги для малого бизнеса
- первый экран лендинга с оффером
- блок "Для кого этот лендинг"
- блок преимуществ лендинга
- блок "Что входит"
- этапы работы
- блок доверия
- FAQ на лендинге
- форма заявки на лендинге через Formspree
- адаптивная верстка лендинга
- ссылка на лендинг из блока "Проекты"
- улучшенный визуальный стиль лендинга
- мягкий фон с `radial-gradient`
- hover-эффекты карточек
- hover-эффекты кнопок
- улучшенная форма заявки на лендинге
- улучшенные SEO meta-теги для `landing.html`
- Open Graph meta-теги для лендинга
- Twitter Card meta-теги для лендинга
- social preview для лендинга
- canonical URL для лендинга
- страница `landing.html` добавлена в `sitemap.xml`
- обновлён `lastmod` в `sitemap.xml`
- будущий сайт для клиента стал конкретнее
- улучшенные описания модальных окон проектов
...
В версии `v2.6` блок “Проекты” усилен и оформлен как витрина frontend-кейсов.

В версии `v2.7` в портфолио добавлен отдельный учебный лендинг услуги, а карточка “Лендинг услуги” стала опубликованным учебным frontend-кейсом.

Теперь раздел показывает не просто список карточек, а объясняет:

- какую задачу решает проект
- какие технологии применяются
- какой результат получился
- какой стек используется
- какие проекты будут развиваться дальше
- почему проект показывает реальные frontend-навыки

В блоке есть три направления:
...
- заголовок блока стал сильнее
- вводный текст стал профессиональнее
- первый проект представлен как опубликованный frontend-кейс
- лучше показаны задача и результат первого проекта
- стек проекта стал понятнее
- добавлен акцент на GitHub Pages, Formspree и PR workflow
- лендинг услуги стал опубликованным учебным frontend-кейсом
- у лендинга появилась отдельная страница `landing.html`
- у лендинга появился отдельный файл стилей `landing.css`
- в карточке лендинга появилась кнопка “Открыть лендинг”
- обновлено описание модального окна проекта
- сайт для клиента стал конкретнее как будущая бизнес-задача
- обновлены статусы проектов
- улучшены списки “Что сделано” и “Что будет сделано”
- улучшены описания модальных окон

Теперь блок “Проекты” лучше показывает практический опыт, рабочий процесс и направление развития портфолио.

### Лендинг услуги

В версии `v2.7` создан первый отдельный учебный лендинг услуги.
...
Лендинг показывает структуру коммерческой страницы:
...
Визуально лендинг был улучшен отдельной задачей:

- фон стал мягче и приятнее
- добавлены `radial-gradient` фоны
...
В версии `v2.8` лендинг технически усилен для SEO:
...
- добавлен social preview через `assets/preview.svg`
- добавлен `og:image:alt`
- страница `landing.html` добавлена в `sitemap.xml`
- обновлён `lastmod` для главной страницы
- добавлена отдельная запись sitemap для лендинга

Лендинг опубликован здесь:

[Открыть лендинг услуги](https://nefrit333-cpu.github.io/my-first-site/landing.html)
...
В версии `v2.8` SEO-база лендинга улучшена отдельно:

- проверен `title` лендинга
- улучшен `meta description` лендинга
- расширены `keywords` лендинга
...
- добавлено social preview изображение
- добавлен alt-текст для preview-изображения
- страница `landing.html` добавлена в `sitemap.xml`

Теперь ссылка на сайт и отдельный лендинг лучше подготовлены для:
...
13. Улучшение визуального стиля лендинга услуги
14. Улучшение SEO и sitemap для лендинга услуги
```
...
- `landing.html` — учебный лендинг услуги
- `landing.css` — стили учебного лендинга услуги
...
- усилении блока “Проекты”
- создании отдельного учебного лендинга
- оформлении лендинга как frontend-кейса
- улучшении визуального стиля лендинга
- добавлении hover-эффектов
- работе с мягкими фонами через `radial-gradient`
- улучшении карточек, кнопок, формы и визуального ритма
- улучшении SEO отдельной страницы
- добавлении Open Graph meta-тегов
- добавлении Twitter Card meta-тегов
- добавлении страницы в `sitemap.xml`
- оформлении проектов как frontend-кейсов
- описании задачи, результата, стека и статуса проекта
...
- [v2.7 — Создание и визуальное улучшение лендинга услуги](https://github.com/nefrit333-cpu/my-first-site/releases/tag/v2.7)
- [v2.8 — Улучшение SEO и sitemap для лендинга услуги](https://github.com/nefrit333-cpu/my-first-site/releases/tag/v2.8)
